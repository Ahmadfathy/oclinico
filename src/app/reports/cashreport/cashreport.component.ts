...
@Component({
  selector: 'app-cashreport',
  templateUrl: './cashreport.component.html',
  styleUrls: ['./cashreport.component.css']
})
export class CashreportComponent implements OnInit {
  ...
  year: any; dates: any; months: any;Year:any;
  userid: string;
  nodata: boolean;
  nodata1: boolean;
     ...
     var accessToken = window.localStorage.Tokenval ;
      ...
      // console.log(result);
        ...
        if (result.status_cd === "1") {
          ...
          this.Details = result.data.Table1;
