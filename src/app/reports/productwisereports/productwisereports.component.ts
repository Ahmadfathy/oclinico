...
@Component({
  selector: 'app-productwisereports',
  templateUrl: './productwisereports.component.html',
  styleUrls: ['./productwisereports.component.css']
})
export class ProductwisereportsComponent implements OnInit {
  public isPageloaderVisible = true;
  products: any = [];  dataTable: any;  data: any = [];  ToDate: any;
  FromDate: any;  To_Date: any;  From_Date: any;
  userid: string;  Day_FromDate: any;  Day_ToDate: any;Year: any;
