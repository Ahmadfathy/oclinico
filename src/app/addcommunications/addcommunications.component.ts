...
export class AddcommunicationsComponent implements OnInit {
  ...
  ValidationMessages = {
    ...
    'smsemail': {
      'required': 'Please select SMS or Email',
     },
    'staffpatient': {
      'required': 'Please select staff/patient',
      'Select':'Please select staff/patient'
     },
    'staffval': {
      'required': 'Please select staff',
      'Select':'Please select staff'
     },
    'mobno': {
    ...
    'doctreat': {
      'required': 'Please select Doctor/Treatment',
     },
    'branchname': {
      'required': 'Please select branch',
     },
    'avlmsg': {
      'required': 'Please enter available messages',
     },
    'sendmsg': {
      'required': 'Please enter send messages',
     }
  ...
  ValidationMessagesarabic = {
    ...
    'smsemail': {
      'required': 'الرجاء اختيار الرسائل القصيرة أو البريد الإلكتروني',
     },
    'staffpatient': {
      'required': 'الرجاء اختيار الموظفين / المريض',
      'Select':'الرجاء اختيار الموظفين / المريض'
     },
    'staffval': {
      'required': 'الرجاء اختيار الموظفين',
      'Select':'الرجاء اختيار الموظفين'
     },
    'mobno': {
      'required': 'الرجاء إدخال رقم الجوال',
     },
    'msg': {
      'required': 'الرجاء ادخل الرسالة',
     },
    'msgmail': {
      'required': 'الرجاء ادخل الرسالة',
     },
    'mto': {
      'required': 'الرجاء إدخال إلى',
    ...
    'doctreat': {
      'required': 'الرجاء اختيار الطبيب / العلاج',
     },
    'branchname': {
      'required': 'الرجاء اختيار الفرع',
     },
    'avlmsg': {
      'required': 'الرجاء إدخال الرسائل المتاحة',
     },
    'sendmsg': {
      'required': 'الرجاء إدخال إرسال الرسائل',
     }
  }
 ...
 //console.log(this.addcommunication.value.branchname.join(","));
  ...
  checkValidationErrors(group: FormGroup = this.addcommunication): void {
    // console.log("sdf");
       ...
       if(this.languageoption=="us" ||this.languageoption==undefined||this.languageoption=="undefined"){
