...
@Component({
  selector: 'app-edit-doct-treatment',
  templateUrl: './edit-doct-treatment.component.html',
  styleUrls: ['./edit-doct-treatment.component.css']
})
export class EditDoctTreatmentComponent implements OnInit {
  nullValue: any;
  ...
  ngOnInit() {
     document.title="Edit_doctor_treatment"
    ...
    this.doctreatid = currentUrl[currentUrl.length - 1]
   // console.log(this.doctreatid);
      ...
      var accessToken=window.localStorage.Tokenval;
       // console.log(accessToken);
        ...
        let params = {
              ...
              "Login_ID":"", 
              "Trans_Date":"", 
              "Operation":"getdoctreatmentdetails",
              "clinicid":"", 
              "Branchid":"", 
              "Last_Updated":"" 
                }
               ...
               // this.PArray=[];
                this.http.post(serviceUrl, params, options).map(res=>res.json()).subscribe(result =>{
                  ...
                  if(result.status_cd === "1"){
                    ...
                    this.docnameid=result.data.Table[0].Practitioner_Id;
                    this.treatmentnameid=result.data.Table[0].Treatment_Id;
                    this.adddoctreatment.patchValue({
                      docname:result.data.Table[0].Practitionername,
                      treatment:result.data.Table[0].Treatmentname,
