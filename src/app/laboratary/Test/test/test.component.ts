...
export class TestsComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    private router: Router, private Services: laborataryTestServices) {
  ...
  insertdata() {
    ...
    if (this.btnText == "Save") {
      this.Services.saveNewTest(this.productForm.value, res => {
      ...
      this.Services.updateTest(this.productForm.value, res => {
