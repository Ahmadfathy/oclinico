...
@Component({
  selector: 'app-view-wards',
  templateUrl: './view-wards.component.html',
  styleUrls: ['./view-wards.component.css']
})
export class ViewWardsComponent implements OnInit {
