...
export class UpcomingComponent implements OnInit {
  ...
  gettoday_data() {
    ...
    let body = {
      ...
      "Login_ID": "",
      "Trans_Date": "",
      "Operation": "bindFutureappointments",
  ...
  submit() {
    ...
    if (this.addappointment.value.emergency == true) {
      ...
      // if(this.addappointment.value.apptdate == null || this.addappointment.value.apptdate == undefined){
      ...
      if (res.data.Table[0].Result == 'True') {
        ...
        if (this.addappointment.value.emergency == true) {
          ...
          this.router.navigateByUrl('/RefrshComponent', { skipLocationChange: true }).then(() =>
            this.router.navigate(["AllComponent"]));
        }
  ...
  exportexcel(table) {
    ...
    var ctx = { worksheet: name || 'Upcoming Appointments', table: table.innerHTML }
